...
class HP_MT_popup_uber(bpy.types.Menu): 
    ...
    def draw(self, context):
        ...
        def cam_props(cam):
            ...
            # Camera.gpu_dof / dof_distance / dof_object are 2.79 API.
            # Since Blender 2.80 everything lives under Camera.dof, and in 5.0
            # the EEVEE engine id went back to 'BLENDER_EEVEE', so this branch
            # is actually reached again.
