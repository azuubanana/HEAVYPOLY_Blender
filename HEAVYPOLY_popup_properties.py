...
#               col.operator('sculpt.dynamic_topology_toggle', text = 'Dynotopo')
                ...
                # Mesh.auto_smooth_angle was removed in Blender 4.1.
                # The angle now lives on the "Smooth by Angle" modifier.
                _sba = ob.modifiers.get("Smooth by Angle") if ob else None
                if _sba:
                    col.prop(_sba, "show_viewport", text="Smooth by Angle")
            ##SECOND COLUMN##############################################################
